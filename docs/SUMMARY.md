...
- [Co-op Mod]()
    - [Engineering Discipline](ENGINEERING_DISCIPLINE.md)
    - [Architecture Decision Records](decisions.md)
    - [Link Cable System — Research Notes](link-system.md)
    - [Multiplayer Packet Protocol](packet-protocol.md)
    - [Flag Sync Design](flag-sync.md)
    - [Object Event System — Research Notes](object-events.md)
    - [Encounter System Reference](encounter-system.md)
    - [Boss Scripts — Gym Leaders, Elite Four, Champion](boss-scripts.md)
    - [Cookbook — Known Issues & Solutions](cookbook.md)
    - [Testing the Link (Two-Instance)](testing-link.md)
    - [Relay Server — Local Testing Guide](relay-testing.md)
    - [App End-to-End Testing Guide](app-testing.md)
    - [Running Lua Scenario Tests Locally](dev/lua-tests.md)
