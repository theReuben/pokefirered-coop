...
enum ScrOp
{
    ...
    SCR_OP_WAITBOSSSTART = 0xE7,
    SCR_OP_WAITSTARTERPICK = 0xE8,
    SCR_OP_DOCOOPTRAINERBATTLE = 0xE9,
    SCR_OP_WAITCOOPPARTY = 0xEA,
    SCR_OP_WAITPARTYSYNC = 0xEB,
    SCR_OP_WAITSTARTERCLAIM = 0xEC,
};
